<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchPage_DataSets.aspx.cs" Inherits="SearchPage_DataSets" %>
...
function LoadResultsCallback(result)
{
	...
	var count = items.Tables.stores.Rows.length;
	...
	{
		var currenttext = items.Tables.stores.Rows[i].Name;
