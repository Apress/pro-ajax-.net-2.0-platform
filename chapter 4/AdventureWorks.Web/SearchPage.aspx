<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchPage.aspx.cs" Inherits="SearchPage_Objects" %>
...
function ReplaceInput(tablecell)
{
	...
	<body onload="BodyLoad();">
		<form id="form1" method="post" runat="server">
			<p><strong style="FONT-SIZE: 24pt">AdventureWorks Store Search:<br />
            <asp:HyperLink ID="lnkHome" runat="server" Font-Size="Medium">>Home</asp:HyperLink></strong></p>
 			<input name="keyword" onkeyup="LoadResults(this.value)" style="WIDTH:300px" autocomplete="off" id="keyword" runat="server"/>

            <asp:Button ID="btnGo" runat="server" Text="Go!" OnClick="btnGo_Click" />
			<div class="box" id="searchresults" style="WIDTH:300px;BACKGROUND-COLOR:#ccccff">
			</div>
		</form>
	</body>
</html>
